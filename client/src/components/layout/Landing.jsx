        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-screen-lg">
            ...
            <p className="mb-8 text-base tracking-wide max-w-screen-md text-center">
              ...
              about bringing coders together in one space to discuss,
              collaborate, and share their passion for coding. Whether you are a
              seasoned pro or just starting out, DevAdda is your place to meet,
              learn, and grow.
            </p>
            <Link to={"/register"}>
